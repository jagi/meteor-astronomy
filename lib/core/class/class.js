...
Astro.Class = class Class {
  constructor(values) {
    ...
    if (!doc.dispatchEvent(new Astro.Event('beforeInit', {
      values: values,
      cancelable: true
    }))) {
  ...
  static getParent() {
    if (this.parentClassName) {
      return Astro.Class.get(this.parentClassName);
    }
  }
  ...
  static create(definition) {
    ...
    // Extend the Class.
    let Class =
      Astro.Class.classes[className] = class Class extends Astro.Class {};
  ...
  static inherit(definition) {
    ...
    let Class =
      Astro.Class.classes[className] = class Class extends ParentClass {};
  ...
  static get(className) {
    return Astro.Class.classes[className];
  }
};