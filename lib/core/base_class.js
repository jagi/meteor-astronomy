var BaseClass = Astro.BaseClass = function BaseClass(attrs) {
  ...
  // Call the "initInstance" events defined on the class level.
  Class.schema.each('initInstance', function(eventHandler) {
    eventHandler.call(doc, attrs);
  });
  // Call the "initInstance" events defined globally.
  Astro.eventManager.each('initInstance', function(eventHandler) {
    eventHandler.call(doc, attrs);
  });

  // Call user defined constructor.
  Class.getConstructor().call(doc, attrs);
};
