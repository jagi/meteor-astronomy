...
Astro.createClass = Astro.Class = function(schemaDefinition) {
  ...
  if (ParentClass) {
    ...
    Class.prototype = Object.create(Astro.base.Class.prototype);
  }
  ...
  Astro.registerType({
    ...
    check: function(value) {
      // Look for the class.
      var Constructor = Astro.classes[Class.getName()];
      return value instanceof Constructor;
    },
    cast: function(attrs) {
      // Look for the class.
      var Constructor = Astro.classes[Class.getName()];
      // If there is no class with the given name, then just return value being
      // casted.
      if (!Constructor) {
        return attrs;
      }
      ...
      // the argument.
      if (attrs instanceof Constructor) {
        return attrs;
      }
