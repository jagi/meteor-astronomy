...
Astro.getCollectionInfo = function(Collection) {
  if (Collection instanceof Mongo.Collection) {
    return Astro.collections[Collection._name];
  } else if (_.isString(Collection)) {
    return Astro.collections(Collection);
  }
};
  ...
  if (Collection) {
    ...
    if (!Collection._transform) {
      ...
      if (_.isFunction(transform)) {
        ...
        Collection._transform = Astro.utils.class.transformToClass(Collection);
      }
    }
  }
