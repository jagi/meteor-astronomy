...
function dispatchEvent(event) {
  ...
  every(eventHandlers, function(eventHandler) {
    eventHandler(event);
  ...
  // Object fields.
  each(Class.getObjectFields(), function(field) {
  ...
  // List fields.
  each(Class.getListFields(), function(field) {
    let value = doc[field.name];
    if (field.isClass && isArray(value)) {
