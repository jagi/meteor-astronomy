var setOne = function(fieldName, fieldValue) {
  ...
  var value = Astro.utils.fields.castValueOfField(Class, fieldName, fieldValue);
  // set it on the document.
  Astro.utils.fields.setValueOfField(doc, fieldName, value);
...
var methods = {
  ...
  save: function(callback) {
    ...
    if (update) {
      ...
      values = Astro.utils.fields.getValuesOfAllFields(this);
    }
