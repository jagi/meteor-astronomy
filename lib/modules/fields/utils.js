...
Astro.utils.fields.getValueOfField = function(doc, fieldName, getDefault) {
  if (_.isUndefined(getDefault)) {
    getDefault = true;
  }
  ...
  if (_.isUndefined(value) && getDefault) {
...
Astro.utils.fields.getValuesOfAllFields = function(doc, getDefault) {
  if (_.isUndefined(getDefault)) {
    getDefault = true;
  }
  var values = {};
  ...
  _.each(fieldsNames, function(fieldName) {
    var value = Astro.utils.fields.getValueOfField(doc, fieldName, getDefault);
    if (!_.isUndefined(value)) {
