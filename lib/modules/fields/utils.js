Astro.utils.fields = {
      ...
      function(nestedDoc, nestedFieldName) {
        ...
        if (Class) {
          ...
          if (field) {
            ...
            Astro.errors.warn('fields.not_defined_field', nestedFieldName, Class.getName());
          }
        }
  ...
  setDefaultValue: function(doc, fieldName) {
    ...
    if (field) {
      ...
      Astro.errors.warn('fields.not_defined_field', fieldName, Class.getName());
    }
  },
        ...
        if (Class) {
          ...
          if (field) {
            ...
            if (_.isUndefined(fieldValue) && options.default) {
              ...
              // Set default value because we should not have undefined fields.
