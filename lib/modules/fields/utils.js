...
Astro.utils.class.castValueOfField = function(Class, fieldName, fieldValue) {
  var fieldDefinition = Astro.utils.class.getDefinitionOfField(
    Class,
    fieldName
  );
...
Astro.utils.class.getDefaultValueOfField = function(Class, fieldName) {
  ...
  var fieldDefinition = Astro.utils.class.getDefinitionOfField(Class,
    fieldName);
...
Astro.utils.instance.collectNamesOfNestedFields = function(doc, pattern) {
...
Astro.utils.instance.getValueOfField = function(doc, fieldName) {
  ...
  if (_.isUndefined(value)) {
    value = Astro.utils.class.getDefaultValueOfField(Class, fieldName);
  }

  return value;
};

Astro.utils.instance.getValuesOfAllFields = function(doc) {
  var values = {};
  var Class = doc.constructor;
...
Astro.utils.instance.setValueOfField = function(doc, fieldName, fieldValue) {
