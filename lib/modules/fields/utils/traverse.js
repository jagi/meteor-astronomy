import isNestedPattern from './is_nested_pattern.js';
import AstroClass from '../../../core/class.js';

function traverse(doc, fieldPattern, callback) {
	if (!doc) {
		return;
	}
