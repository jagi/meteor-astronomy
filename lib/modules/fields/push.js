    ...
    function(nestedDoc, nestedFieldName, Class, field, index) {
      ...
      if (options.modifier) {
        ...
        if (nestedDoc instanceof Astro.BaseClass) {
          ...
          changed = doc._addModifier('$push', fieldName, modifierPushedValue);
        }
      } else {
