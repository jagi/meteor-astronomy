var save = function(callback) {
  ...
  // parent schemas.
  _.each(this.constructor.schemas, function(schema) {
    schema.triggerEvent(update ? 'beforeupdate' : 'beforeinsert', null, this);
  });
  ...
  // parent schemas.
  _.each(this.constructor.schemas, function(schema) {
    schema.triggerEvent(update ? 'afterupdate' : 'afterinsert', null, this);
  });
...
var getOne = function(fieldName) {
  ...
  // Trigger the "beforeget" global event handlers.
  Astro.eventManager.each('beforeget', function(eventHandler) {
    eventHandler.apply(this, [fieldName]);
  }, this);
  ...
  // Trigger the "afterget" global event handlers.
  Astro.eventManager.each('afterget', function(eventHandler) {
    eventHandler.apply(this, [fieldName]);
  }, this);
...
var setOne = function(fieldName, value) {
  ...
  // Trigger the "beforeset" global event handlers.
  Astro.eventManager.each('beforeset', function(eventHandler) {
    eventHandler.apply(this, [fieldName, value]);
  }, this);
  ...
  // Trigger the "afterset" global event handlers.
  Astro.eventManager.each('afterset', function(eventHandler) {
    eventHandler.apply(this, [fieldName, value]);
  }, this);
};
