...
var fieldsClassMethods = {
  ...
  addField: function(fieldName, fieldDefinition) {
    ...
    if (_.isUndefined(fieldDefinition) || _.isNull(fieldDefinition)) {
      ...
      fieldDefinition = new Astro.FieldDefinition({
        name: fieldName
      });
      ...
      fieldDefinition = new Astro.FieldDefinition(fieldDefinition);
  ...
  addFields: function(fieldsNames) {
    ...
    } else if (_.isObject(fieldsNames)) {
