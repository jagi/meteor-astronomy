...
methods._setValue = function(fieldName, fieldValue, options) {
  var doc = this;
...
methods._setOne = function(fieldName, fieldValue) {
  var doc = this;
  var Class = doc.constructor;
  var event;

  // Deny changing the "_id" property.
  if (fieldName === '_id' && doc._getValue('_id')) {
    return;
  }
  ...
  doc._setValue(fieldName, fieldValue);
...
methods._setMany = function(fieldsValues) {
  var doc = this;
