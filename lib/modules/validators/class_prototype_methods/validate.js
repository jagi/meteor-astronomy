...
methods.validate = function(fieldsNames, stopOnFirstError, callback) {
  let doc = this;
	...
	if (!Match.test(callback, Boolean)) {
  ...
  if (!Meteor.isServer) {
    ...
    let methodName = '/Astronomy/documentValidate';
  ...
  // be on the server or the collection may be local.
    ...
    try {
      ...
      return wrappedCallback(
				undefined,
				Astro.utils.validators.documentValidate(
