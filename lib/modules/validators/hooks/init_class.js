...
import staticValidate from '../class_static_methods/validate.js';
import staticValidateAll from '../class_static_methods/validateAll.js';
...
function onInitClass(Class, className) {
	...
	Class.validate = staticValidate;
	Class.validateAll = staticValidateAll;
	// Class prototype methods.
