...
Astro.Class = function(definition) {
  ...
  _.each(Modules, function(Module) {
    if (
      _.has(Module, 'oninitschema') &&
      _.isFunction(Module.oninitschema)
    ) {
      Module.oninitschema.call(Class.schema, Class, definition);
    }
  });
  ...
  _.each(Modules, function(Module) {
    if (
      _.has(Module, 'oninitclass') &&
      _.isFunction(Module.oninitclass)
    ) {
      Module.oninitclass.call(Class);
    }
  });
